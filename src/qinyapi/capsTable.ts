...
export const STATIC_CAPS: Record<string, StaticCaps> = {
  ...
  'Claude计次组|K次claude-opus-4-6': { vision: true, tool: true, format: true },
  'Claude计次组|K次claude-opus-4-7': { vision: true, tool: true, format: true },
  'Claude计次组|K次claude-sonnet-4-6': { vision: true, tool: true, format: true },
  ...
  '默认组|K次claude-opus-4-6': { vision: true, tool: true, format: true },
  '默认组|K次claude-opus-4-7': { vision: true, tool: true, format: true },
  '默认组|K次claude-sonnet-4-6': { vision: true, tool: true, format: true },
