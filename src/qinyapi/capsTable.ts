...
export const STATIC_CAPS: Record<string, StaticCaps> = {
  ...
  'ClaudeCode组|claude-opus-4-7': { vision: true, tool: true, format: true },
  'ClaudeCode组|claude-opus-4-8': { vision: true, tool: true, format: true },
  ...
  'Claude计次组|K次claude-opus-4-8': { vision: true, tool: true, format: true },
  'Claude计次组|按次claude-opus-4-8': { vision: true, tool: true, format: true },
